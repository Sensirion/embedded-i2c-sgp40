# Sensirion Embedded I2C SGP40 Driver

This is a generic embedded driver for the Sensirion SGP40 sensor. It enables developers to communicate with the
SGP40 sensor on different hardware platforms by only adapting the I2C communication related source files.

<center><img src="images/SGP40.png" width="500px"></center>
...
4. Run the compiled executable with `./sgp40_i2c_example_usage`
